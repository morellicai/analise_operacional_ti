...
with col1:
    st.metric(label='Volume de Cards Finalizados', value=cards_finalizados_count)
with col2:
...
st.space()
st.subheader("Gráfico de Chamados:")

chart_col1, chart_col2, chart_col3 = st.columns(3, border=True, gap='medium')
